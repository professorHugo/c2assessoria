  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Usuário não Logado</h5>
      ...
      <div class="modal-body">
        <div class="col-md-12 text-center">
            ...
            <div class="col-md-12 text-center">
            <p>O usuário não pode ser conectado, verifique seu usuário e senha</p>
            </div>
        </div>
        <meta http-equiv="refresh" content="2;./" >
      <div class="modal-footer">
        <a href="./" class="btn btn-secondary" data-dismiss="modal">Tentar novamente</a>
      </div>
    </div>
  </div>
</div>
