<?php
//Variáveis base
"Estado Civil Associado: " . $EstadoCivilAssociado = $_POST['estado_civil'];
"<br> Profissão Associado: " . $ProfissaoAssociado = $_POST['profissao_associado'];
"<br> Associado tem outros Veículos? " . $OutrosVeiculosAssociado = $_POST['outro_veiculo'];
