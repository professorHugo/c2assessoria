...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 30-Jun-2021 às 15:31
...
CREATE TABLE IF NOT EXISTS `tb_associados` (
  ...
  `cpf_associado` bigint(11) DEFAULT NULL,
...
(1, 2949006590, 3, 'Lucas Silveira da Silva', '42722020', 'Rua JosÃ© Leite, 9994', 'Caji', 'Lauro de Freitas', 'BA', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2),
(2, 12345678910, 4, 'Ariosvaldo da Silva Neves', '03308030', 'Rua Coronel Joaquim AntÃ´nio Dias, 251', 'Vila Azevedo', 'SÃ£o Paulo', 'SP', NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2),
(3, 11122233344, 3, 'Lucas Silveira da Silva', '42722020', 'Rua JosÃ© Leite, 9994', 'Caji', 'Lauro de Freitas', 'BA', NULL, NULL, NULL, NULL, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2);
...
--
-- Extraindo dados da tabela `tb_caracteristicas_tecnicas`
--

INSERT INTO `tb_caracteristicas_tecnicas` (`id_caracteristica`, `protocolo_caracteristica`, `indice_criminalidade`, `indice_sinistralidade`, `caracteristicas_tecnicas`, `rua_pavimentada`, `permitido_estacionar`, `aclive_declive`, `tipo_direcao_pista`, `cruzamento_pista`, `pista_curvas`, `pista_rotatoria`, `velocidade_maxima`) VALUES
(1, '1A2B3C', 'Baixo', 'MÃ©dio', 'PÃ¡tio de empresa privada', 'Pavimentada', 'Sim', 'Plano', 'Sentido Ãšnico - Simples', 'NÃ£o HÃ¡ Cruzamento', 'Sem Curvas', 'NÃ£o', 1);
...
INSERT INTO `tb_condutores` (`id_condutor`, `protocolo_evento`, `nome_condutor`, `civil_condutor`, `profissao_condutor`, `cep_condutor`, `endereco_condutor`, `bairro_condutor`, `cidade_condutor`, `estado_condutor`, `veiculo_proprio`, `qtd_veiculo_proprio`, `veiculo1_condutor`, `veiculo2_condutor`, `veiculo3_condutor`, `vinculo_associado`, `cnh_condutor`, `relato_condutor`, `documento_frente`, `documento_verso`, `declaracao1`, `declaracao2`, `declaracao3`, `perfil_salvo`) VALUES
(1, '1A2B3C4D', 'Cleide da Silva Neves', NULL, NULL, '03308030', 'Rua Coronel Joaquim AntÃ´nio Dias, 251', 'Vila Azevedo', 'SÃ£o Paulo', 'SP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2);
...
--
-- Extraindo dados da tabela `tb_copom`
--

INSERT INTO `tb_copom` (`id_copom`, `protocolo_copom`, `comunicado_copom`, `texto_divergencia`, `foto1_copom`, `foto2_copom`, `foto3_copom`, `foto4_copom`, `foto5_copom`, `foto6_copom`) VALUES
(2, '1A2B3C4D5E', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Extraindo dados da tabela `tb_documento_veiculo`
--

INSERT INTO `tb_documento_veiculo` (`id_documento`, `protocolo_documento`, `foto_frente_documento`, `foto_verso_documento`, `documento_preenchido`) VALUES
(1, '1A2B3C', 2, 3, 2);
...
INSERT INTO `tb_entrevistados` (`id_entrevistado`, `protocolo_entrevistados`, `tipo_entrevistado`, `testemunha_entrevistado`, `perfil_entrevistado`, `nome_entrevistado`, `relacionamento_entrevistado`, `telefone_entrevistado`, `cep_entrevistado`, `endereco_entrevistado`, `numero_end_entrevistado`, `bairro_entrevistado`, `cidade_entrevistado`, `estado_entrevistado`, `foto1_entrevistado`, `foto2_entrevistado`, `foto3_entrevistado`, `foto4_entrevistado`, `foto5_entrevistado`, `foto6_entrevistado`, `documento_entrevistado_frente`, `documento_entrevistado_verso`, `observacao_entrevistado`, `informacao_salva`) VALUES
(1, '1A2B3C', '2', '1', '1', 'JosÃ© Pereira da Silva', 'Pai', '', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Qualquer coisa', 'Sim'),
(2, '1A2B3C', '1', '1', '1', 'Clayton', 'Amigo', '', '', '', '', '', '', '', 6, 7, NULL, NULL, NULL, NULL, 4, 5, 'Testemunha', 'Sim'),
(3, '1A2B3C4D', '1', '1', '2', 'Teste de salvamento', 'Amigo', '', '', '', '', '', '', '', 10, 11, NULL, NULL, NULL, NULL, 8, 9, 'teste', 'Sim'),
(4, '1A2B3C4D5E', '1', '0', NULL, 'Fulano de Tal', '', '', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Resumo da declaraÃ§Ã£o apresentada pelo Entrevistado como testemunha do evento ocorrido', 'Sim'),
(5, '1A2B3C4D5E', '2', '0', NULL, 'Cleitinho da Silva', '', '', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Resumo da declaraÃ§Ã£o apresentada pelo entrevistado', 'Sim');
...
--
-- Extraindo dados da tabela `tb_entrevistados_convivio`
--

INSERT INTO `tb_entrevistados_convivio` (`id_sabedores`, `protocolo_sabedores`, `representante_sabedor`, `total_sabedores`, `confirmacao1_sabedores`, `confirmacao2_sabedores`, `confirmacao3_sabedores`, `confirmacao4_sabedores`, `confirmacao5_sabedores`, `confirmacao6_sabedores`, `confirmacao7_sabedores`, `confirmacao8_sabedores`, `informacao_geral_sabedores`, `sabedores_salvo`) VALUES
(1, '1A2B3C', '1', '3', 'Confirmam a versÃ£o, ratificam os informes', 'NÃ£o houve apontamento de embriaguez/entorpecentes', 'Apontamento de Troca de condutor', 'Apontamento de velocidade incompatÃ­vel', 'O veÃ­culo conhecido em bom estado', 'VeÃ­culo pernoita na garagem', 'Conhecido como pessoa de boa Ã­ndole', 'Boa conduta', NULL, 'Sim'),
(2, '1A2B3C4D', '2', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `tb_fotos` (
  ...
  PRIMARY KEY (`id_foto`)
) ENGINE=InnoDB AUTO_INCREMENT=137 DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci;
...
(2, 'foto_frente_documento_veiculo', '1A2B3C', '02949006590', 'Documento_Frente_Veiculo.jpg'),
(3, 'foto_verso_documento_veiculo', '1A2B3C', '02949006590', 'Documento_Verso_Veiculo.jpg'),
(4, 'foto_documento_entrevistado_frente', '1A2B3C', '02949006590', 'Foto_Documento_Entrevistado2_Frente.png'),
(5, 'foto_documento_entrevistado_verso', '1A2B3C', '02949006590', 'Foto_Documento_Entrevistado2_Verso.jpg'),
(6, 'foto_declaracao_entrevistado1', '1A2B3C', '02949006590', 'Foto_Declaracao1_Entrevistado2.jpg'),
(7, 'foto_declaracao_entrevistado2', '1A2B3C', '02949006590', 'Foto_Declaracao2_Entrevistado2.png'),
(8, 'foto_documento_entrevistado_frente', '1A2B3C4D', '12345678910', 'Foto_Documento_Entrevistado3_Frente.jpg'),
(9, 'foto_documento_entrevistado_verso', '1A2B3C4D', '12345678910', 'Foto_Documento_Entrevistado3_Verso.jpg'),
(10, 'foto_declaracao_entrevistado1', '1A2B3C4D', '12345678910', 'Foto_Declaracao1_Entrevistado3.jpg'),
(11, 'foto_declaracao_entrevistado2', '1A2B3C4D', '12345678910', 'Foto_Declaracao2_Entrevistado3.jpg'),
(24, 'foto_multa1', '1A2B3C4D5E', '11122233344', 'Foto_Multa1.jpg'),
(25, 'foto_multa2', '1A2B3C4D5E', '11122233344', 'Foto_Multa2.jpg'),
(26, 'foto_multa3', '1A2B3C4D5E', '11122233344', 'Foto_Multa3.png'),
(27, 'foto1_vistoria', '1A2B3C4D5E', '11122233344', 'Foto_Vistoria1.png'),
(28, 'foto2_vistoria', '1A2B3C4D5E', '11122233344', 'Foto_Vistoria2.jpg'),
(29, 'foto3_vistoria', '1A2B3C4D5E', '11122233344', 'Foto_Vistoria3.jpg'),
(30, 'foto_evento1', '1A2B3C4D5E', '11122233344', 'Foto_LocalEvento1.jpg'),
(31, 'foto_evento2', '1A2B3C4D5E', '11122233344', 'Foto_LocalEvento2.jpg'),
(32, 'foto_evento3', '1A2B3C4D5E', '11122233344', 'Foto_LocalEvento3.jpg'),
(125, 'print_pesquisas_img1', '1A2B3C4D5E', '11122233344', 'print_pesquisas_img1.jpg'),
(126, 'print_pesquisas_img2', '1A2B3C4D5E', '11122233344', 'print_pesquisas_img2.jpg'),
(127, 'print_pesquisas_img3', '1A2B3C4D5E', '11122233344', 'print_pesquisas_img3.png'),
(128, 'print_pesquisas_img4', '1A2B3C4D5E', '11122233344', 'print_pesquisas_img4.png'),
(129, 'print_pesquisas_img5', '1A2B3C4D5E', '11122233344', 'print_pesquisas_img5.jpg'),
(130, 'print_pesquisas_img6', '1A2B3C4D5E', '11122233344', 'print_pesquisas_img6.jpg'),
(131, 'print_pesquisas_img7', '1A2B3C4D5E', '11122233344', 'print_pesquisas_img7.jpg'),
(132, 'print_pesquisas_img8', '1A2B3C4D5E', '11122233344', 'print_pesquisas_img8.jpg'),
(133, 'print_pesquisas_img9', '1A2B3C4D5E', '11122233344', 'print_pesquisas_img9.jpg'),
(134, 'print_pesquisas_img10', '1A2B3C4D5E', '11122233344', 'print_pesquisas_img10.jpg'),
(135, 'print_pesquisas_img11', '1A2B3C4D5E', '11122233344', 'print_pesquisas_img11.jpg'),
(136, 'print_pesquisas_img12', '1A2B3C4D5E', '11122233344', 'print_pesquisas_img12.jpg');
...
INSERT INTO `tb_local_evento` (`id_local_evento`, `protocolo_local_evento`, `testemunha_entrevistado`, `quantidade_entrevistados`, `fotos_local_evento`, `foto1_local_evento`, `foto2_local_evento`, `foto3_local_evento`, `confirmacao1_local`, `confirmacao2_local`, `confirmacao3_local`, `confirmacao4_local`, `confirmacao5_local`, `confirmacao6_local`, `local_evento_salvo`) VALUES
(1, '1A2B3C4D5E', 0, 1, NULL, 30, 31, 32, 'Confirmam a versÃ£o, ratificam os informes', 'NÃ£o houve apontamento de embriaguez/entorpecentes', 'Apontamento de Troca de condutor', 'Apontamento de velocidade incompatÃ­vel', NULL, NULL, 'Sim');
...
(1, '1A2B3C', '2021-05-30 19:13:14', 1, 3, 'Nova SindicÃ¢ncia', '\r\n          VocÃª recebeu uma nova sindicÃ¢ncia, vÃ¡ atÃ© RelatÃ³rios para visualizar os detalhes\r\n        ', 0, NULL),
(2, '1A2B3C4D', '2021-06-10 14:08:12', 1, 3, 'Nova SindicÃ¢ncia', '\r\n          VocÃª recebeu uma nova sindicÃ¢ncia, vÃ¡ atÃ© RelatÃ³rios para visualizar os detalhes\r\n        ', 0, NULL),
(3, '1A2B3C4D5E', '2021-06-26 14:15:03', 1, 3, 'Nova SindicÃ¢ncia', '\r\n          VocÃª recebeu uma nova sindicÃ¢ncia, vÃ¡ atÃ© RelatÃ³rios para visualizar os detalhes\r\n        ', 0, NULL);
...
--
-- Estrutura da tabela `tb_orgaos_publicos`
--

DROP TABLE IF EXISTS `tb_orgaos_publicos`;
CREATE TABLE IF NOT EXISTS `tb_orgaos_publicos` (
  `id_orgaos_publicos` int(11) NOT NULL AUTO_INCREMENT,
  `protocolo_orgaos_publicos` varchar(50) COLLATE utf8_general_mysql500_ci DEFAULT NULL,
  `orgaos_publicos_fotos` int(11) DEFAULT NULL COMMENT 'FK tb_orgaos_publicos_fotos',
  `orgaos_publicos_pc` int(11) DEFAULT NULL COMMENT '1: sim | 2: não',
  `pc_resultado1` varchar(100) COLLATE utf8_general_mysql500_ci DEFAULT NULL COMMENT 'Texto sobre opção escolhida',
  `pc_resultado2` varchar(100) COLLATE utf8_general_mysql500_ci DEFAULT NULL COMMENT 'Texto sobre opção escolhida',
  `pc_resultado3` varchar(100) COLLATE utf8_general_mysql500_ci DEFAULT NULL COMMENT 'Texto sobre opção escolhida',
  `orgaos_publicos_pm` int(11) DEFAULT NULL COMMENT '1: sim | 2: não',
  `pm_resultado1` varchar(100) COLLATE utf8_general_mysql500_ci DEFAULT NULL COMMENT 'Texto sobre opção escolhida',
  `pm_resultado2` varchar(100) COLLATE utf8_general_mysql500_ci DEFAULT NULL COMMENT 'Texto sobre opção escolhida',
  `pm_resultado3` varchar(100) COLLATE utf8_general_mysql500_ci DEFAULT NULL COMMENT 'Texto sobre opção escolhida',
  PRIMARY KEY (`id_orgaos_publicos`),
  KEY `orgaos_publicos_fotos` (`orgaos_publicos_fotos`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci;

--
-- Extraindo dados da tabela `tb_orgaos_publicos`
--

INSERT INTO `tb_orgaos_publicos` (`id_orgaos_publicos`, `protocolo_orgaos_publicos`, `orgaos_publicos_fotos`, `orgaos_publicos_pc`, `pc_resultado1`, `pc_resultado2`, `pc_resultado3`, `orgaos_publicos_pm`, `pm_resultado1`, `pm_resultado2`, `pm_resultado3`) VALUES
(22, '1A2B3C4D5E', 19, 1, 'Em pesquisas, nÃ£o hÃ¡ irregularidades apontadas no boletim de ocorrÃªncia.', 'HÃ¡ boletim de ocorrÃªncia do evento em questÃ£o nÃ£o apresentado.', 'HÃ¡ boletim de ocorrÃªncia relacionado ao veÃ­culo em data anterior ao evento.', 1, 'Em pesquisas, nÃ£o hÃ¡ irregularidades apontadas no boletim de ocorrÃªncia.', 'HÃ¡ boletim de ocorrÃªncia do evento em questÃ£o nÃ£o apresentado.', 'HÃ¡ boletim de ocorrÃªncia relacionado ao veÃ­culo em data anterior ao evento.');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_orgaos_publicos_fotos`
--

DROP TABLE IF EXISTS `tb_orgaos_publicos_fotos`;
CREATE TABLE IF NOT EXISTS `tb_orgaos_publicos_fotos` (
  `id_orgaos_publicos_fotos` int(11) NOT NULL AUTO_INCREMENT,
  `orgaos_publicos_fotos_protocolo` varchar(50) COLLATE utf8_general_mysql500_ci DEFAULT NULL,
  `orgaos_publicos_imagem1` int(11) DEFAULT NULL COMMENT 'FK tb_fotos',
  `orgaos_publicos_imagem2` int(11) DEFAULT NULL COMMENT 'FK tb_fotos',
  `orgaos_publicos_imagem3` int(11) DEFAULT NULL COMMENT 'FK tb_fotos',
  `orgaos_publicos_imagem4` int(11) DEFAULT NULL COMMENT 'FK tb_fotos',
  `orgaos_publicos_imagem5` int(11) DEFAULT NULL COMMENT 'FK tb_fotos',
  `orgaos_publicos_imagem6` int(11) DEFAULT NULL COMMENT 'FK tb_fotos',
  `orgaos_publicos_imagem7` int(11) DEFAULT NULL COMMENT 'FK tb_fotos',
  `orgaos_publicos_imagem8` int(11) DEFAULT NULL COMMENT 'FK tb_fotos',
  `orgaos_publicos_imagem9` int(11) DEFAULT NULL COMMENT 'FK tb_fotos',
  `orgaos_publicos_imagem10` int(11) DEFAULT NULL COMMENT 'FK tb_fotos',
  `orgaos_publicos_imagem11` int(11) DEFAULT NULL COMMENT 'FK tb_fotos',
  `orgaos_publicos_imagem12` int(11) DEFAULT NULL COMMENT 'FK tb_fotos',
  PRIMARY KEY (`id_orgaos_publicos_fotos`),
  KEY `orgaos_publicos_imagem1` (`orgaos_publicos_imagem1`),
  KEY `orgaos_publicos_imagem2` (`orgaos_publicos_imagem2`),
  KEY `orgaos_publicos_imagem3` (`orgaos_publicos_imagem3`),
  KEY `orgaos_publicos_imagem4` (`orgaos_publicos_imagem4`),
  KEY `orgaos_publicos_imagem5` (`orgaos_publicos_imagem5`),
  KEY `orgaos_publicos_imagem6` (`orgaos_publicos_imagem6`),
  KEY `orgaos_publicos_imagem7` (`orgaos_publicos_imagem7`),
  KEY `orgaos_publicos_imagem8` (`orgaos_publicos_imagem8`),
  KEY `orgaos_publicos_imagem9` (`orgaos_publicos_imagem9`),
  KEY `orgaos_publicos_imagem10` (`orgaos_publicos_imagem10`),
  KEY `orgaos_publicos_imagem11` (`orgaos_publicos_imagem11`),
  KEY `orgaos_publicos_imagem12` (`orgaos_publicos_imagem12`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci;

--
-- Extraindo dados da tabela `tb_orgaos_publicos_fotos`
--

INSERT INTO `tb_orgaos_publicos_fotos` (`id_orgaos_publicos_fotos`, `orgaos_publicos_fotos_protocolo`, `orgaos_publicos_imagem1`, `orgaos_publicos_imagem2`, `orgaos_publicos_imagem3`, `orgaos_publicos_imagem4`, `orgaos_publicos_imagem5`, `orgaos_publicos_imagem6`, `orgaos_publicos_imagem7`, `orgaos_publicos_imagem8`, `orgaos_publicos_imagem9`, `orgaos_publicos_imagem10`, `orgaos_publicos_imagem11`, `orgaos_publicos_imagem12`) VALUES
(19, '1A2B3C4D5E', 125, 126, 127, 128, 129, 130, 131, 132, 133, 134, 135, 136);
...
--
-- Extraindo dados da tabela `tb_proprietario_legal`
--

INSERT INTO `tb_proprietario_legal` (`id_proprietario`, `protocolo_proprietario`, `nome_proprietario`, `vinculo_associado`, `proprietario_anterior`, `observacao_proprietario`, `foto_declaracao_proprietario1`, `foto_declaracao_proprietario2`, `foto_declaracao_proprietario3`, `foto_documento_proprietario_frente`, `foto_documento_proprietario_verso`) VALUES
(1, '1A2B3C', 'Lucas Silveira da Silva', 'Associado', NULL, 'Teste de cadastro', NULL, NULL, NULL, NULL, NULL);
...
--
-- Extraindo dados da tabela `tb_registro_detran`
--

INSERT INTO `tb_registro_detran` (`id_registro_detran`, `protocolo_registro_detran`, `estado_registro_detran`, `multa_registro_detran`, `foto1_multa`, `foto2_multa`, `foto3_multa`, `restricoes_diversas`, `restricoes_financeiras`, `queixa_registro`, `outras_informacoes_registro`) VALUES
(1, '1A2B3C', 6, 2, NULL, NULL, NULL, 2, NULL, NULL, NULL),
(4, '1A2B3C4D5E', 6, 1, 24, 25, 26, 1, 'Sim', 'Sim', 'Teste de inserÃ§Ã£o');
...
CREATE TABLE IF NOT EXISTS `tb_relatorios` (
  ...
  `orgaos_publicos` int(11) DEFAULT NULL COMMENT 'FK tb_orgaos_publicos',
  ...
  KEY `orgaos_publicos` (`orgaos_publicos`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci;
...
INSERT INTO `tb_relatorios` (`id_relatorio`, `horario_criacao`, `horario_update`, `solicitante_evento`, `sindicante_evento`, `protocolo_evento`, `natureza_evento`, `cpf_associado`, `condutor_veiculo`, `condutor_evento`, `placa_veiculo_evento`, `data_evento`, `horario_evento`, `cep_evento`, `endereco_evento`, `numero_evento`, `bairro_evento`, `cidade_evento`, `uf_evento`, `caracteristicas_local_evento`, `boletim_ocorrencia`, `orgaos_publicos`, `policia_civil`, `policia_militar`, `registro_copom`, `registro_mobilidade`, `registro_motorista_app`, `registro_local_evento`, `status_relatorio`, `contexto_geral_relatorio`, `dinamica_do_evento`, `print_associado`, `print_condutor`) VALUES
(1, '2021-05-30 22:13:12', '2021-06-04 18:31:00', 3, 3, '1A2B3C', 1, '02949006590', 1, NULL, 'OUT8184', '2021-05-01', '20:07', '42711830', 'Rua Doutor Gerino de Souza Filho', '', 'Caixa D\'Ãgua', 'Lauro de Freitas', 'BA', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Preenchendo', NULL, NULL, NULL, NULL),
(2, '2021-06-10 17:08:10', '2021-06-10 17:54:00', 4, 3, '1A2B3C4D', 1, '12345678910', 2, NULL, 'AAA1111', '2021-06-01', '15:07', '03308030', 'Rua Coronel Joaquim AntÃ´nio Dias', '', 'Vila Azevedo', 'SÃ£o Paulo', 'SP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Preenchendo', NULL, NULL, NULL, NULL),
(3, '2021-06-26 17:15:00', '2021-06-28 22:38:00', 3, 3, '1A2B3C4D5E', 1, '11122233344', 1, NULL, 'OUT8181', '2021-06-05', '14:06', '42711830', 'Rua Doutor Gerino de Souza Filho', '', 'Caixa D\'Ãgua', 'Lauro de Freitas', 'BA', NULL, NULL, 22, NULL, NULL, 2, NULL, NULL, 1, 'Preenchendo', NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `tb_sistemas_anti_furto` (
  ...
  `texto_outros` varchar(50) COLLATE utf8_general_mysql500_ci NOT NULL COMMENT 'Caso seja outro tipo de sistema antifurto',
...
INSERT INTO `tb_sistemas_anti_furto` (`id_sistema`, `protocolo_sistema`, `tipo_sistema`, `texto_outros`, `foto_comprovante1`, `foto_comprovante2`, `telemetria1`, `telemetria2`, `telemetria3`) VALUES
(1, '1A2B3C', '2', '', NULL, NULL, NULL, NULL, NULL),
(3, '1A2B3C4D5E', '4', 'Trava de direÃ§Ã£o', NULL, NULL, NULL, NULL, NULL);
...
(3, 'hugo.allnet@gmail.com', 'Sindcante Hugo', 4, 2, 1, 2);
...
(1, '02949006590', 1, '1A2B3C', 1, 'HONDA', 'NXR 150 Bros', 'OUT8184', 'Sim', 1, NULL, NULL, NULL, 1, NULL, NULL, NULL, 1, NULL, NULL),
(2, '12345678910', NULL, '1A2B3C4D', 2, 'TOYOTA', 'COROLLA 4P GASOLINA', 'AAA1111', 'Sim', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, '11122233344', NULL, '1A2B3C4D5E', 1, 'HONDA', 'NXR 150 Bros', 'OUT8181', 'Sim', NULL, NULL, NULL, NULL, 3, NULL, NULL, 3, 4, NULL, NULL);
...
INSERT INTO `tb_vistorias_realizadas` (`id_vistoria`, `protocolo_vistoria`, `vistoria_aprovada`, `data_vistoria`, `foto1_vistoria`, `foto2_vistoria`, `foto3_vistoria`) VALUES
(3, '1A2B3C4D5E', 'Sim', '2021-05-30', 27, 28, 29);
...
--
-- Limitadores para a tabela `tb_orgaos_publicos`
--
ALTER TABLE `tb_orgaos_publicos`
  ADD CONSTRAINT `tb_orgaos_publicos_ibfk_1` FOREIGN KEY (`orgaos_publicos_fotos`) REFERENCES `tb_orgaos_publicos_fotos` (`id_orgaos_publicos_fotos`);

--
-- Limitadores para a tabela `tb_orgaos_publicos_fotos`
--
ALTER TABLE `tb_orgaos_publicos_fotos`
  ADD CONSTRAINT `tb_orgaos_publicos_fotos_ibfk_1` FOREIGN KEY (`orgaos_publicos_imagem1`) REFERENCES `tb_fotos` (`id_foto`),
  ADD CONSTRAINT `tb_orgaos_publicos_fotos_ibfk_10` FOREIGN KEY (`orgaos_publicos_imagem10`) REFERENCES `tb_fotos` (`id_foto`),
  ADD CONSTRAINT `tb_orgaos_publicos_fotos_ibfk_11` FOREIGN KEY (`orgaos_publicos_imagem11`) REFERENCES `tb_fotos` (`id_foto`),
  ADD CONSTRAINT `tb_orgaos_publicos_fotos_ibfk_12` FOREIGN KEY (`orgaos_publicos_imagem12`) REFERENCES `tb_fotos` (`id_foto`),
  ADD CONSTRAINT `tb_orgaos_publicos_fotos_ibfk_2` FOREIGN KEY (`orgaos_publicos_imagem2`) REFERENCES `tb_fotos` (`id_foto`),
  ADD CONSTRAINT `tb_orgaos_publicos_fotos_ibfk_3` FOREIGN KEY (`orgaos_publicos_imagem3`) REFERENCES `tb_fotos` (`id_foto`),
  ADD CONSTRAINT `tb_orgaos_publicos_fotos_ibfk_4` FOREIGN KEY (`orgaos_publicos_imagem4`) REFERENCES `tb_fotos` (`id_foto`),
  ADD CONSTRAINT `tb_orgaos_publicos_fotos_ibfk_5` FOREIGN KEY (`orgaos_publicos_imagem5`) REFERENCES `tb_fotos` (`id_foto`),
  ADD CONSTRAINT `tb_orgaos_publicos_fotos_ibfk_6` FOREIGN KEY (`orgaos_publicos_imagem6`) REFERENCES `tb_fotos` (`id_foto`),
  ADD CONSTRAINT `tb_orgaos_publicos_fotos_ibfk_7` FOREIGN KEY (`orgaos_publicos_imagem7`) REFERENCES `tb_fotos` (`id_foto`),
  ADD CONSTRAINT `tb_orgaos_publicos_fotos_ibfk_8` FOREIGN KEY (`orgaos_publicos_imagem8`) REFERENCES `tb_fotos` (`id_foto`),
  ADD CONSTRAINT `tb_orgaos_publicos_fotos_ibfk_9` FOREIGN KEY (`orgaos_publicos_imagem9`) REFERENCES `tb_fotos` (`id_foto`);
...
ALTER TABLE `tb_relatorios`
  ...
  ADD CONSTRAINT `tb_relatorios_ibfk_13` FOREIGN KEY (`orgaos_publicos`) REFERENCES `tb_orgaos_publicos` (`id_orgaos_publicos`),
