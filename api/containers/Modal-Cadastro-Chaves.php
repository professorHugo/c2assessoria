...
<!-- Modal Cadastro de Chaves -->
<div class="modal fade" id="CadastroChaves" tabindex="-1" aria-labelledby="CadastroChavesLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <form action="?Page=Settings&Chaves&Cadastrar" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="CadastroChavesLabel">Cadastrar Naturezas</h5>
