function acionarVeiculosAdicionais(){
    ...
    v_xhttp.open("GET", "./js/Step4/Veiculos-Adicionais.php?Acionado=" + veiculosAdicionais , true);
    v_xhttp.send(null);
}
...
function quantidadeAdicionar(){
    ...
    vadd_xhttp.open("GET", "./js/Step4/Veiculos-Adicionais-Quantidade.php?Quantidade=" + veiculosQuantidade , true);
