function acionarVeiculosProprios(){
    ...
    returnVeiculosProprios.innerHTML = '<img src="../img/ajax-loader.gif" class="img-responsive">';
    ...
    v_xhttp.open("GET", "./js/Veiculos-Adicionais-Condutor.php?Acionado=" + veiculosProprios , true);
    v_xhttp.send(null);
}
...
function quantidadeAdicionarCondutor(){
    ...
    vadd_xhttp.open("GET", "./js/Veiculos-Adicionais-Quantidade-Condutor.php?Quantidade=" + veiculosQuantidade , true);
