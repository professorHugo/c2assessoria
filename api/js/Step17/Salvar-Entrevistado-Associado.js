function SalvarEntrevistadoAssociado(){
    ...
    ajax.open(
        "GET"
        ,"js/Step17/Salvar-Entrevistado-Associado.php?protocolo="+protocolo+"&nome="+nome+"&sexo="+sexo+"&tipo="+tipo+"&cep="+cep+"&end="+end+"&num="+num+"&bairro="+bairro+"&cidade="+cidade+"&estado="+estado+"&nacionalidade="+nacionalidade+"&telefone="+telefone
        ,true
    );
    ajax.send(null);
}