$(function(){
  ...
  $('#print_mobilidade_urbana_img5').on('change', function() {
   ...
   $('#button-upload-mobilidade_urbana_img6').on('click', function() {
    $('#print_mobilidade_urbana_img6').trigger('click');
  });

  $('#print_mobilidade_urbana_img6').on('change', function() {
    var fileName = $(this)[0].files[0].name;
    $('#file_mobilidade_urbana_img6').val(fileName);
  });
