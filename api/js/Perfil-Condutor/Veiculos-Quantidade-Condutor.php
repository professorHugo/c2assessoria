    ...
    if($Quantidade == 1){
        ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-xs-12 col-md-12">
                    <input type="text" value="BBB1111" id="placa_veiculo1" name="placa_veiculo1" class="form-control form-control-lg" placeholder="ABC1234" required>
                </div>
            </div>
        ...
        ?>
            ...
            <div class="form-group row">
                ...
                <label for="placa_veiculo2" class="col-xs-12 col-md-12 col-form-label col-form-label-lg">Placa:</label>
                <div class="col-xs-12 col-md-12">
                    <input type="text" value="BBB2222" id="placa_veiculo2" name="placa_veiculo2" class="form-control form-control-lg" placeholder="ABC1234" required>
                </div>
            </div>
        ...
        ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-xs-12 col-md-12">
                    <input type="text" value="BBB3333" id="placa_veiculo3" name="placa_veiculo3" class="form-control form-control-lg" placeholder="ABC1234" required>
                </div>
            </div>
