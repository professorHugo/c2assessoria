function carregarMulta(){
    ...
    return_evento_multa_veiculo.innerHTML = '<img src="../img/ajax-loader.gif" class="img-responsive">';
...
function carregarRestricao(){
    ...
    return_restricoes_diversas.innerHTML = '<img src="../img/ajax-loader.gif" class="img-responsive">';
...
function carregarRestricoesF(){
    ...
    return_restricoes_financeiras.innerHTML = '<img src="../img/ajax-loader.gif" class="img-responsive">';
...
function carregarQueixa(){
    ...
    return_queixa_veiculo.innerHTML = '<img src="../img/ajax-loader.gif" class="img-responsive">';
