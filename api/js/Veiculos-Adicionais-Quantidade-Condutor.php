...
if(isset($_GET['Quantidade'])){
    ...
    ?>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-md-12">
                <input type="text" value="ABC1234" id="placa_veiculo1_condutor" name="placa_veiculo1_condutor" class="form-control form-control-lg" placeholder="ABC1234" required>
            </div>
        </div>
    ...
    ?>
        ...
        <div class="form-group row">
            ...
            <label for="placa_veiculo2_condutor" class="col-xs-12 col-md-12 col-form-label col-form-label-lg">Placa:</label>
            <div class="col-xs-12 col-md-12">
                <input type="text" value="ABC4321" id="placa_veiculo2_condutor" name="placa_veiculo2_condutor" class="form-control form-control-lg" placeholder="ABC1234" required>
            </div>
        </div>
    ...
    ?>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-md-12">
                <input type="text" value="BCA1234" id="placa_veiculo3_condutor" name="placa_veiculo3_condutor" class="form-control form-control-lg" placeholder="ABC1234" required>
            </div>
        </div>
