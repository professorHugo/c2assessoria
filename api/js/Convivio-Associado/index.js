...
function SalvarTestemunha(){
  ...
  ajax.open(
      "GET"
      ,"js/Convivio-Associado/Salvar-Testemunhas.php?protocolo="+protocolo+"&tipo_convivio="+tipo_convivio+"&nome="+nome+"&tipo="+tipo+"&cep="+cep+"&end="+end+"&num="+num+"&bairro="+bairro+"&cidade="+cidade+"&estado="+estado+"&telefone="+telefone+"&observacao="+observacao
      ,true
  );
  ajax.send(null);
}
