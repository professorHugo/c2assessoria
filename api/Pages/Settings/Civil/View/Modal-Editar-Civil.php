...
<div class="modal fade" id="EditarCivil<?php echo $ReturnCivil['id_civil']?>" tabindex="-1" aria-labelledby="EditarCivilLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <form action="?Page=Settings&Civil" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="EditarCivilLabel">Editar Estado Civil: <?php echo $ReturnCivil['descricao_civil']?></h5>
