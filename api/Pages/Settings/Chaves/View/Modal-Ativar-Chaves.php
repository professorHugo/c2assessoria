...
<div class="modal fade" id="AtivarChaves<?php echo $ReturnChaves['id_chave']?>" tabindex="-1" aria-labelledby="AtivarChavesLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <form action="?Page=Settings&Chaves" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="AtivarChavesLabel">Ativar tipo de chave: <?php echo $ReturnChaves['descricao_chave']?></h5>
