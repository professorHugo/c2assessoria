<!-- Modal Ativar de Natureza -->
<div class="modal fade" id="AtivarNatureza<?php echo $ReturnNaturezas['id_natureza']?>" tabindex="-1" aria-labelledby="AtivarNaturezaLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <form action="?Page=Settings&Naturezas" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="AtivarNaturezaLabel">Ativar Natureza: <?php echo $ReturnNaturezas['descricao_natureza']?></h5>
