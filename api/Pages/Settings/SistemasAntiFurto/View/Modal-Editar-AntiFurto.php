<!-- Modal Editar chave -->
<div class="modal fade" id="EditarAntiFurto<?php echo $ReturnAntiFurto['id_sistema']?>" tabindex="-1" aria-labelledby="EditarAntiFurtoLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <form action="?Page=Settings&SistemasAntiFurto" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="EditarAntiFurtoLabel">Editar Sistema Anti Furto: <?php echo $ReturnAntiFurto['tipo_sistema']?></h5>
