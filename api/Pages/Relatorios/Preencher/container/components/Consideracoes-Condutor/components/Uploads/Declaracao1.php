<?php
  if( $SysMode == 1 ){
    ...
    if( is_dir($PastaAssociado) ){
      ...
      $_FILES['print_foto_declaracao_condutor1']['name'];
  
      $extensao = pathinfo( $_FILES['print_foto_declaracao_condutor1']['name'] );
      echo "<br>Extensão do arquivo: " . $extensao = "." . $extensao['extension'];
      echo "<br>Pasta para upload: " . $target_dir = $PastaAssociado;
      echo "<br>Nome do arquivo: " . $Declaracao1 = "Declaracao_Condutor1".$extensao;
      echo "<br>Arquivo de destinho: " . $target_file = $target_dir . $Declaracao1;
      echo "<br>";
  
      if( move_uploaded_file($_FILES['print_foto_declaracao_condutor1']['tmp_name'], $target_file) ){
        echo "<br>Foto 1 da declaração carregada, Atualizar cadastro do condutor";
        ...
        $QueryBuscarFotoDeclaracao1 = "
          SELECT * FROM 
            tb_fotos
          WHERE
            categoria_foto = 'declaracao_condutor1' &&
        ...
        if( $RowQrBuscarFotoDeclaracao1 < 1 ){
          ...
          if( $ExeQrCadastraFotoDeclaracao1 ){
            ...
            if( $ExeQrUpdateDeclaracao1 ){
              echo "<br>Foto 1 da declaração do Condutor atualizado";
            }
          }
        }
      }
    ...
    if( is_dir($PastaAssociado) ){
      ...
      "<br>Nome do arquivo: " . $Declaracao1 = "Declaracao_Condutor1".$extensao;
      "<br>Arquivo de destinho: " . $target_file = $target_dir . $Declaracao1;
      "<br>";
  
      if( move_uploaded_file($_FILES['print_foto_declaracao_condutor1']['tmp_name'], $target_file) ){
        "<br>Foto 1 da declaração carregada, Atualizar cadastro do condutor";
        ...
        if( $RowQrBuscarFotoDeclaracao1 < 1 ){
          ...
          if( $ExeQrCadastraFotoDeclaracao1 ){
            ...
            if( $ExeQrUpdateDeclaracao1 ){
              "<br>Foto 1 da declaração do Condutor atualizado";
            }
          }
        }
      }
