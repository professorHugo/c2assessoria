...
<div id="foto1" style="width: 100%">
  ...
  <div class="col-7 float-left" style="margin-top: 10px">
    <input 
      ...
      id="print_policia_militar_img1"
      style="display: none;"
    >
    <input 
      type="text" 
      name="file_policia_militar_img1" 
      id="file_policia_militar_img1"
    ...
    <button 
      ...
      id="button-upload-policia_militar_img1"
    >
...
<div id="foto2">
  ...
  <div class="col-7 float-left" style="margin-top: 10px">
    <input 
      ...
      id="print_policia_militar_img2"
      style="display: none;"
    >
    <input 
      type="text" 
      name="file_policia_militar_img2" 
      id="file_policia_militar_img2"
      placeholder="Escolha o arquivo"
      class="form-control form-control-lg col-9 float-left"
      readonly
    >
    <button 
      type="button" 
      class="btn-default form-control form-control-lg col-3 float-left"
      id="button-upload-policia_militar_img2"
    >
      <i class="fa fa-upload" aria-hidden="true"></i>
    </button>
  </div>
...
<div id="foto3">
  ...
  <div class="col-7 float-left" style="margin-top: 10px">
    <input 
      ...
      id="print_policia_militar_img3"
      style="display: none;"
    >
    <input 
      type="text" 
      name="file_policia_militar_img3" 
      id="file_policia_militar_img3"
      placeholder="Escolha o arquivo"
      class="form-control form-control-lg col-9 float-left"
      readonly
    >
    <button 
      type="button" 
      class="btn-default form-control form-control-lg col-3 float-left"
      id="button-upload-policia_militar_img3"
    >
      <i class="fa fa-upload" aria-hidden="true"></i>
    </button>
  </div>
...
<div id="foto4">
  ...
  <div class="col-7 float-left" style="margin-top: 10px">
    <input 
      ...
      id="print_policia_militar_img4"
      style="display: none;"
    >
    <input 
      type="text" 
      name="file_policia_militar_img4" 
      id="file_policia_militar_img4"
      placeholder="Escolha o arquivo"
      class="form-control form-control-lg col-9 float-left"
      readonly
    >
    <button 
      type="button" 
      class="btn-default form-control form-control-lg col-3 float-left"
      id="button-upload-policia_militar_img4"
    >
      <i class="fa fa-upload" aria-hidden="true"></i>
    </button>
  </div>
...
<div id="foto5">
  ...
  <div class="col-7 float-left" style="margin-top: 10px">
    <input 
      ...
      id="print_policia_militar_img5"
      style="display: none;"
    >
    <input 
      type="text" 
      name="file_policia_militar_img5" 
      id="file_policia_militar_img5"
      placeholder="Escolha o arquivo"
      class="form-control form-control-lg col-9 float-left"
      readonly
    >
