<script src="js/Policia-Militar/File-Buttons.js"></script>
<form
  action="?Page=Relatorios&Preencher&Protocolo=<?php echo $Protocolo?>&Content=Policia-Militar&Salvar"
...
>
  ...
  <div class="form-group row" id="img-policia-militar">
    <?php include 'components/containers/Img-Policia-Militar.php';?>
  </div>
