  ...
  if( $SysMode == 1 ){
    ...
    if( $RowQrBuascarEntrevistadosConvivio < 1 ){
      ...
      if( $ExeQrUpdateEntrevistadosConvivio = mysqli_query($connection, $QueryUpdateEntrevistadosConvivio) ){
        echo "<br>Registros totais de sabedores no convívio do condutor foi atualizado com sucesso";
      }else{
    ...
    if( $RowQrBuascarEntrevistadosConvivio < 1 ){
      ...
      "</pre>";
      if( $ExeQrUpdateEntrevistadosConvivio = mysqli_query($connection, $QueryUpdateEntrevistadosConvivio) ){
        "<br>Registros totais de sabedores no convívio do condutor foi atualizado com sucesso";
      }else{
        echo "<br>Erro: " . mysqli_error($connection);
      }
    }
