        ...
        while( $Testemunha = mysqli_fetch_assoc($ExeQrBuscarTestemunhas) ){
          ...
          ?>
            <div class="col-12">
              ...
              <a 
                href="?Page=Relatorios&Preencher&Protocolo=<?php echo $Protocolo ?>&Content=Convivio-Condutor&Entrevistado=<?php echo $IdEntrevistado ?>">
...
<?php
  ...
  if( isset($_POST['Salvar']) && isset($_GET['SalvarEntrevistado']) ){
    ...
    // echo "<meta http-equiv='refresh' content='0;?Page=Relatorios&Preencher&Protocolo=$Protocolo&Content=Convivio-Condutor'>";
  }
