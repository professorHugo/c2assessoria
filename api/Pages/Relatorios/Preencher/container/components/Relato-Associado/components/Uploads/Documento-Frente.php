<?php
  if( $SysMode == 1 ){
    ...
    if( is_dir($PastaAssociado) ){
      echo "<br>Foto documento Frente: " . $_FILES['print_foto_documento_associado_frente']['name'];
  
      $extensao = pathinfo( $_FILES['print_foto_documento_associado_frente']['name'] );
      echo "<br>Extensão do arquivo: " . $extensao = "." . $extensao['extension'];
      echo "<br>Pasta para upload: " . $target_dir = $PastaAssociado;
      echo "<br>Nome do arquivo: " . $DocumentoFrente = "Documento_Associado_Frente".$extensao;
      echo "<br>Arquivo de destinho: " . $target_file = $target_dir . $DocumentoFrente;
      echo "<br>";
  
      if( move_uploaded_file( $_FILES['print_foto_documento_associado_frente']['tmp_name'], $target_file ) ){
        ...
        $QueryBuscarFotoDocumentoFrente = "
          SELECT * FROM 
            tb_fotos
          WHERE
            categoria_foto = 'documento_associado_frente' &&
    ...
    if( is_dir($PastaAssociado) ){
      "<br>Foto documento Frente: " . $_FILES['print_foto_documento_associado_frente']['name'];
  
      $extensao = pathinfo( $_FILES['print_foto_documento_associado_frente']['name'] );
      "<br>Extensão do arquivo: " . $extensao = "." . $extensao['extension'];
      "<br>Pasta para upload: " . $target_dir = $PastaAssociado;
      "<br>Nome do arquivo: " . $DocumentoFrente = "Documento_Associado_Frente".$extensao;
