<div class="col-12 float-left" id="mensagem_atencao">
  <h6 class="text-center">
    ...
    Após adicionar as <b>testemunhas</b> (caso necessário), você deverá confirmar os dados apresentados 
    pelas testemunhas e poderá inserir as imagens de suas declarações. <br><br>
