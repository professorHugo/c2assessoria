...
<div class="clearfix col-12" style="margin-top: 10px"></div>
<!-- Sistema Antifurto -->
<div class="col-sm-6 col-md-3 float-left" style="margin-top: 10px">
  <label for="sistema_antifurto" class="col-form-label col-form-label-lg label-dados-relatorios">
    Sistema Antifurto
  </label>
</div>
<div class="col-sm-6 col-md-9 float-left" style="margin-top: 10px">
  <a 
