  ...
  if( $SysMode == 1 ){
    ...
    if( $RowQrBuscarSabedoresConvivio > 0 ){
      ...
      ?>
        ...
        <form 
          action="
            ?Page=Relatorios&Preencher&Protocolo=<?php echo $Protocolo?>&Content=Convivio-Associado&Salvar-Sabedores"
          ...
          <?php
            if( $SysMode == 1 ){
              ...
              $QueryBuscarLocalEvento = "
                ...
                WHERE protocolo_sabedores = '$Protocolo' && representante_sabedor = 1
              ";
              echo "</pre>";
            }else{
              "<br><pre>" .
