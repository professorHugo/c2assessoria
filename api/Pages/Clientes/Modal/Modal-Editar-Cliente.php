<!-- Modal Editar de Cliente -->
<div class="modal fade" id="EditarCliente<?php echo $ReturnClientes['id_cliente']?>" tabindex="-1" aria-labelledby="EditarClienteLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <form action="?Page=Clientes&Cadastrar" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="EditarClienteLabel">Editar Cliente <?php echo $ReturnClientes['nome_cliente']?></h5>
