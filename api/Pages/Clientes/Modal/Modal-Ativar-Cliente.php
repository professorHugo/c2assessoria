<!-- Modal Ativar de Cliente -->
<div class="modal fade" id="AtivarCliente<?php echo $ReturnClientes['id_cliente']?>" tabindex="-1" aria-labelledby="AtivarClienteLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <form action="?Page=Clientes&Ativar" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="AtivarClienteLabel">Ativar Cliente: <?php echo $ReturnClientes['nome_cliente']?></h5>
