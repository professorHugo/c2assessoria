...
create table tb_associados(
    ...
    veiculo_segurado int DEFAULT null,
    ...
    FOREIGN KEY(veiculo_segurado) REFERENCES tb_veiculos(id_veiculo),
...
create table tb_relatorios(
    ...
    FOREIGN KEY(veiculo_extra1) REFERENCES tb_veiculos(id_veiculo),
    FOREIGN KEY(veiculo_extra2) REFERENCES tb_veiculos(id_veiculo),
    FOREIGN KEY(veiculo_extra3) REFERENCES tb_veiculos(id_veiculo)
)ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_mysql500_ci;
